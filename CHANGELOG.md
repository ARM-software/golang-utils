...
- :sparkles: `[filesystem]` Added a way to follow symlink `EvalSymlinks` (#20251117115305)
- :sparkles: `[url]` Add a new package containing url helper functions (#20251124113919)
...
- :sparkles: [headers] Added utilities for header sanitisation (#20251024170139)
...
- :bug: [headers] Fix header search due to normalisation of the name by go (#20251024170358)
...
- :sparkles: [headers] support for [TUS](https://tus.io/protocols/resumable-upload) headers (#20250925093723)
- :sparkles: `[collection]` Add a `MapWithError` function (#20250925122057)
...
- :sparkles: `[parallelisation]` Define a transformation group (#20250905171217)
- :sparkles: `[collection]` Added a `Range` function to populate slices of integers (#20250908111211)
...
- :sparkles: `[proc]` Add utilities to kill processes gracefully (#20250715105927)
...
- :bug: `[subprocess]` make sure child processes are killed on context cancellation (#20250714171923)
...
- :bug: `[parallelisation]` Clean cancel function store after functions have been cancelled (#20250710210822)
...
- :bug: `validation` Make sure to expose validation rule as a `validation.Rule` (#20250708131716)
...
- :sparkles: `parallelisation` Add wait with context function (#20250606172923)
- :sparkles: `subprocess` Add interrupt with context and interrupt signal option (#20250606172951)
