...
//
//	mockgen -destination=../../mocks/mock_saga.go -package=mocks github.com/ARM-software/golang-utils/utils/transaction/saga IActionArguments,IActionIdentifier,ITransactionStep,ISagaOrchestrator
//
...
import (
	...
	saga "github.com/ARM-software/golang-utils/utils/transaction/saga"
...
func (m *MockITransactionStep) Compensate(ctx context.Context, args saga.IActionArguments) error {
	m.ctrl.T.Helper()
...
func (m *MockITransactionStep) Execute(ctx context.Context, args saga.IActionArguments) error {
	m.ctrl.T.Helper()
...
func (m *MockITransactionStep) GetID() saga.IActionIdentifier {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetID")
	ret0, _ := ret[0].(saga.IActionIdentifier)
	return ret0
}
...
func (m *MockISagaOrchestrator) Clone() parallelisation.IExecutionGroup[saga.ITransactionStep] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Clone")
	ret0, _ := ret[0].(parallelisation.IExecutionGroup[saga.ITransactionStep])
	return ret0
}
...
func (m *MockISagaOrchestrator) CopyFunctions(g parallelisation.IExecutionGroup[saga.ITransactionStep]) {
	m.ctrl.T.Helper()
...
func (m *MockISagaOrchestrator) RegisterFunction(function ...saga.ITransactionStep) {
	m.ctrl.T.Helper()
	varargs := []any{}
...
func (m *MockISagaOrchestrator) RegisterFunctions(function iter.Seq[saga.ITransactionStep]) {
	m.ctrl.T.Helper()
