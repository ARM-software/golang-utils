...
func (m *MockLoggers) Log(arg0 ...any) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
...
func (mr *MockLoggersMockRecorder) LogError(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoggersMockRecorder) SetLogSource(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoggersMockRecorder) SetLoggerSource(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIMultipleLoggersMockRecorder) Append(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIMultipleLoggersMockRecorder) AppendLogger(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Log mocks base method.
func (m *MockIMultipleLoggers) Log(arg0 ...any) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
...
// Log indicates an expected call of Log.
func (mr *MockIMultipleLoggersMockRecorder) Log(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Log", reflect.TypeOf((*MockIMultipleLoggers)(nil).Log), arg0...)
}

// LogError mocks base method.
func (m *MockIMultipleLoggers) LogError(arg0 ...any) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
...
// LogError indicates an expected call of LogError.
func (mr *MockIMultipleLoggersMockRecorder) LogError(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetLogSource indicates an expected call of SetLogSource.
func (mr *MockIMultipleLoggersMockRecorder) SetLogSource(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetLoggerSource indicates an expected call of SetLoggerSource.
func (mr *MockIMultipleLoggersMockRecorder) SetLoggerSource(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWriterWithSourceMockRecorder) SetSource(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWriterWithSourceMockRecorder) Write(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStdLoggerMockRecorder) Output(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
