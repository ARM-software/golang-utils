...
// Source: github.com/ARM-software/golang-utils/utils/filesystem (interfaces: IFileHash,Chowner,Linker,File,DiskUsage,FileTimeInfo,ILock,ILimits,FS,ICloseableFS)
