...
func (mr *MockIHashMockRecorder) Calculate(arg0 any) *gomock.Call {
...
func (m *MockIHash) CalculateWithContext(arg0 context.Context, arg1 io.Reader) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIHashMockRecorder) CalculateWithContext(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CalculateWithContext", reflect.TypeOf((*MockIHash)(nil).CalculateWithContext), arg0, arg1)
}
